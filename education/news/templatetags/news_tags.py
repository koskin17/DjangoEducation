...
def show_categories():    # Можно передавать дополнительные параметры (def show_categories(arg1='Hello', arg2='World')
    categories = Category.objects.all()
    return {"categories": categories}   # При передачи доп. параметров в функцию return должен выглядеть с из возвратом, чтобы увидеть их значения return {"categories": categories, "arg1": arg1, "arg2": arg2}